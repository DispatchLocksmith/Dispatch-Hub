...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .detail-card { max-width:520px;padding:2rem;align-items:flex-start; }
  .detail-card .card-name { font-size:15px; }
  @media(max-width:680px){
    .sidebar{display:none}.main{padding:1rem}
    .mobile-nav{display:flex;overflow-x:auto;gap:6px;padding:0.75rem 1rem;background:var(--surface);border-bottom:0.5px solid var(--border)}
...
<main class="main">
  ...
  <div id="timesheet" class="section"><div class="page-header"><h1>Timesheet</h1></div><div class="card detail-card"><div class="card-icon ci-blue"><i class="ti ti-clock"></i></div><div class="card-name">Open Timesheet</div><div class="card-desc">Track and submit your daily hours.</div><a href="https://docs.google.com/spreadsheets/d/1v1fS2Y2QY1238_Oyu8cWDVhDIQLKL6I4GIMslL24fhQ/edit?gid=1391968688#gid=1391968688" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Timesheet</a></div></div>

  <div id="schedule2026" class="section"><div class="page-header"><h1>2026 Schedule</h1></div><div class="card detail-card"><div class="card-icon ci-teal"><i class="ti ti-calendar-event"></i></div><div class="card-name">View 2026 Schedule</div><div class="card-desc">Full year schedule for all dispatchers.</div><a href="https://docs.google.com/spreadsheets/d/1v1fS2Y2QY1238_Oyu8cWDVhDIQLKL6I4GIMslL24fhQ/edit?gid=1436791790#gid=1436791790" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Schedule</a></div></div>
  ...
  <div id="logins" class="section"><div class="page-header"><h1>Logins</h1></div><div class="card detail-card"><div class="card-icon ci-gray"><i class="ti ti-lock"></i></div><div class="card-name">Login Sheet</div><div class="card-desc">Replace href with your credentials doc link.</div><a href="#" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Logins</a></div></div>
  <div id="uleadz" class="section"><div class="page-header"><h1>uLeadz</h1></div><div class="card detail-card"><div class="card-icon ci-teal"><i class="ti ti-users"></i></div><div class="card-name">Open uLeadz</div><div class="card-desc">Replace href with your uLeadz URL.</div><a href="#" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open uLeadz</a></div></div>
  <div id="pricing" class="section"><div class="page-header"><h1>Pricing</h1></div><div class="card detail-card"><div class="card-icon ci-amber"><i class="ti ti-currency-dollar"></i></div><div class="card-name">Pricing Sheet</div><div class="card-desc">Replace href with your pricing document.</div><a href="#" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Pricing</a></div></div>
  <div id="taskguide" class="section"><div class="page-header"><h1>Task Guide</h1></div><div class="card detail-card"><div class="card-icon ci-purple"><i class="ti ti-list"></i></div><div class="card-name">Task Guide</div><div class="card-desc">Replace href with your task guide link.</div><a href="#" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Task Guide</a></div></div>
  <div id="checklist" class="section"><div class="page-header"><h1>Checklist</h1></div><div class="card detail-card"><div class="card-icon ci-coral"><i class="ti ti-checkbox"></i></div><div class="card-name">Shift Checklist</div><div class="card-desc">Replace href with your checklist link.</div><a href="#" target="_blank" class="open-btn"><i class="ti ti-external-link"></i> Open Checklist</a></div></div>
